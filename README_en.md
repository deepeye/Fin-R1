...
[![License](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE) [![Download the model](https://img.shields.io/badge/🤗-Download the model-blue)](https://huggingface.co/SUFE-AIFLM-Lab/Fin-R1) [![Obtain the dataset](https://img.shields.io/badge/📁-Obtain the dataset-green)](https://huggingface.co/datasets/SUFE-AIFLM-Lab/Fin-R1-Data) [![Technical documentation](https://img.shields.io/badge/📚-Technical documentation-orange)](#)        
